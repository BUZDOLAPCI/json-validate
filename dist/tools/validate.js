...
export function validateJson(input) {
    try {
        ...
        return createErrorResponse('INTERNAL_ERROR', `Validation failed: ${err instanceof Error ? err.message : String(err)}`, { error: err instanceof Error ? err.stack : undefined });
    }
}
/**
